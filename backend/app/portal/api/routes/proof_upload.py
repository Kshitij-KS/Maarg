...
from app.portal.db.portal_tables import append_record, proof_media_by_id
from app.portal.schemas.portal_schemas import PortalUser, ProofMedia, ProofUploadCreate
from app.portal.services.proof_service import create_proof_media
