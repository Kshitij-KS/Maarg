...
from src.api.adapters.gold_reader import mode
from src.api.routes import contract, demo, desert, facility, query, trace
from src.api.schemas import HealthResponse
from src.api.settings import get_settings
from src.portal.api.router import portal_router
