...
from app.portal.api.dependencies import require_admin
from app.portal.db.portal_tables import proof_media, proof_media_by_id
from app.portal.schemas.portal_schemas import ProofMedia
