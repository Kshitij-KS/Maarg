...
from app.reasoning.tracing.mlflow_setup import fallback_trace_spans, init_mlflow
...
def get_trace(trace_id: str) -> TraceResponse:
    fallback_spans = fallback_trace_spans(trace_id)
    if fallback_spans:
        return TraceResponse(
            ...
            spans=[
                TraceSpan(
                    ...
                    attributes=_mapping(span["attributes"]),
                )
