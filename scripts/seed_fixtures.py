...
It writes JSON matching `src.shared.schemas` so all Person B code stays mock-first.
"""
...
from src.shared.schemas import CapabilityClaim, Citation, FacilityTrustRecord, PinCodeDesert
...
def main() -> None:
    ...
    print("Wrote fallback mock Gold fixtures to fixtures/.")
