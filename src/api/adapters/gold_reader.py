...
The canonical mock/real switch remains in `src.shared.catalog`; this adapter
keeps API routes decoupled from the catalog module shape.
"""

from __future__ import annotations

from src.shared.catalog import current_mode, load_facility_trust, load_pin_desert
